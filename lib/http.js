 ...
 * cannot spend a visitor's rate limit. The Origin check covers clients that
 * send one without preflighting.
 *
 ...
 * added later. Do not replace it with a hardcoded allowlist. The editor posts
 * to a relative URL, so a legitimate request never crosses between them.
 */
